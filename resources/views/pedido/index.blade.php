...
@section('content')
 ...
 @can('crear-pedidos')
 <a href="pedidos/create" class="btn btn-primary">Nuevo Pedido</a>
 @endcan



 <table class="table table-responsive-sm table-striped table-bordered shadow-lg  mt-4" id="pedidos" >
	<thead class="bg-info text-white"  >
		<tr>
			<th class="col-1">ID</th>
			<th class="col-1">RAZON SOCIAL PROVEEDOR</th>
			<th class="col-1">FECHA PEDIDO</th>
