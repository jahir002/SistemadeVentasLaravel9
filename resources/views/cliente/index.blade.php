...
@section('content')
 ...
 <table class="table table-responsive-sm table-striped table-bordered shadow-lg  mt-4" id="clientes" >
	<thead class="bg-info text-white"  >
		<tr>
			
			<th class="col-4">NOMBRE</th>
			<th class="col-4">TIPO DE DOCUMENTO</th>
			<th class="col-4">NUMERO DE DOCUMENTO</th>
